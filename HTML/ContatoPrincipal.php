...
<body>
    <nav class="navbar navbar-expand-lg bg-light nav">
        <div class="container-fluid menu">
          <a class="navbar-brand imagem" href="Index.php"><img class="color" width="170" height="30" class="color" src="../Imagens/LogoCadastrar.png" alt="PalaceHotel 4,9 estrelas"></a>
          <div class="textos" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item color">
                <p class="nav-link tag-a color text">Já possui o cadastro?</p>
              </li>
              <li class="nav-item color">
